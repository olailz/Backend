...
public class MedicalHisoryController {
    ...
    public MedicalHisoryController(MedicalHistoryService medicalHistoryService, MedicoService medicoService, PatientService patientService)
        {
